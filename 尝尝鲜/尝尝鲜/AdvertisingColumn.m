...
- (id) initWithFrame:(CGRect)frame
{
	...
	if (self) {
		_scrollView = [[UIScrollView alloc]initWithFrame:CGRectMake(5, 0, CGRectGetWidth(frame)-10, CGRectGetHeight(frame))];
		...
		UIView *containerView = [[UIView alloc] initWithFrame:CGRectMake(5, CGRectGetHeight(self.frame)-20, CGRectGetWidth(self.frame)-10, 20)];
		...
		alphaView.backgroundColor = [UIColor colorWithRed:192.0f/255.0f green:37.0f/255.0f blue:62.0f/255.0f alpha:0.7f];
...
//		
//		self.aLabel = [[UILabel alloc]initWithFrame:CGRectMake(10, 35, CGRectGetWidth(containerView.frame)-20, 30)];
//		self.aLabel.text = @"菜谱分类";
//		[containerView addSubview:self.aLabel];
